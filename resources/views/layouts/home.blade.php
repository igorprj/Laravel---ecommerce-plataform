    ...
    <div class="container">
      <div
        ...
        <ul
          ...
          <li><a href="/sobre" class="nav-link px-2 text-white">About</a></li>
        </ul>
        <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search" action="{{ route('products.search') }}" method="GET">
          <input
            type="search"
        ...
        <div class="text-end">
          <div class="d-flex gap-2">
            ...
            <a {{ route('cadastro') }} type="button" class="btn btn-warning">Sign-up</a>
